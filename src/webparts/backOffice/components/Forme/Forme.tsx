    ...
    <div style={{ position: 'relative' }}>
      <form className={styles.formContainer1} onSubmit={handleSubmit}>
        <div className={styles.inputField}>
          <input type="text" id="offre_title" name="offre_title" value={formData.offre_title} onChange={handleInputChange} placeholder="Title" className={styles.OffreTitle} style={{ backgroundColor: '#F5F9FF' }} />
        </div>
        <span>&nbsp;</span>
        <div className={styles.inputField}>
          ...
          {formEntries.map((entry, index) => (
            <div key={index} className={styles.record}>
              ...
              <div className={styles.recordField}>
                {entry.fileUrl ? (
                  <span className={styles.fileLink} onClick={() => window.open(entry.fileUrl, '_blank')}>
